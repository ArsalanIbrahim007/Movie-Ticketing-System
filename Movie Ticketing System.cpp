...
if (sameMovie)
{
    ...
    {
        cout << "Invalid movie choice! Returning to the main menu.\n";
        return;
    }
    ...
    {
        cout << "Invalid timing selection! Returning to the main menu.\n";
        return;
    }
    ...
    {
        cout << "Invalid format selection! Returning to the main menu.\n";
        return;
    }
    ...
    if (format == 1)
    {
        ...
        if (glassesChoice == 'Y' || glassesChoice == 'y')
        {
            ...
            cout << "You have not chosen 3D glasses.\n";
        }
    }
    else if (format == 2)
    {
